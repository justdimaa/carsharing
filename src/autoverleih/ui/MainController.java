...
public final class MainController
{
    ...
    private void auflistenAutos(ActionEvent pEvent) 
    {
		...
		this.lbNachricht.setText(String.format("Es wurden %s Datensätze gefunden", lAutos.size()));
     ...
     * nach den ausgewählten Kriterien {@link #cbName} und {@link #cbAnschaffungsdatum},
